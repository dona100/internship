...
#         # Check if the request method is GET
#         if request.method == 'GET':
#             # Check for custom permissions for the GET method
#             if request.user.has_perm('api.view_employee'):
#                 # Allow access to employee model details
#                 return view.queryset.model.__name__ == 'Employee'  # Assuming Employee is the model name
#             if request.user.has_perm('api.view_timecycle'):
#                 # Allow access to timecycle model details
#                 return view.queryset.model.__name__ == 'TimeCycle'  # Assuming TimeCycle is the model name
#             return False  # Deny access if no appropriate permissions are found for GET requests
